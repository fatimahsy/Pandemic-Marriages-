...
The dataset has 544 rows and 6 columns. Each row represents the number of marriage licenses issued at a civic center during a given month, along with a corresponding year and a constructed date column. @tbl-marriage-license-sample describes the variables included in the dataset. These variables include: 
...
The data is organised by moth and aggregated for each civic center. While it would have been benefitial to have data at the daily level, the monthy data still allows for meaningful analysis of seasonal trends. 
